...
- You CAN use web search / fetch tools to pull latest docs, SDK changelogs, API references, or vendor announcements when a question depends on external behavior that may have changed since your training cutoff.
